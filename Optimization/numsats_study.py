...
#### Constellation
num_orbits = 14                                                     # Number of orbits in the constellation              
sats_per_orbit = 4                                                  # Number of satellites per orbit                  
#num_sats = 14                                                      # Number of satellites in the constellation
...
## loop for increasing number of satellites
alleffs = []
for num_sats in range(14, 60, 1):
    ...
    alleffs.append(consteff)
    print("Number of satellites: ", num_sats, "Efficiency: ", consteff)

plt.scatter(range(14, 60, 1), alleffs)
plt.xlabel("Number of satellites")
plt.ylabel("Efficiency")
plt.title("Efficiency of the constellation with increasing number of satellites")
plt.savefig("Optimization\sim_results\constellation_benchmark.png")
plt.show()